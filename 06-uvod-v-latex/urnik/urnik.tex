...
\newpage \subsection{Vhodni podatki} % podrazdelek
...
omejitve so bile kršene ter kolikokrat se kršitev pojavi. S \(kˇn\) označimo število
kršitev omejitve \(n\), z \(uˇn\) pa njeno utež. Z naslednjo formulo izračunamo
kakovost urnika:
??
